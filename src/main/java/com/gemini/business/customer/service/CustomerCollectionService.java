...
*/
public interface CustomerCollectionService extends BaseDetailService<CustomerCollectionPo, CustomerCollectionPo, CustomerCollectionMapper, CustomerCollectionMapper> {
}